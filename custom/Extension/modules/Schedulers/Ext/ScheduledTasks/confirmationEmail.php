...
function confirmationEmail()
{
    ...
    $result = $db->query("SELECT id, k_email, k_buyer_name, k_test_center, k_date_and_time, k_driving_test_ref_no FROM k_bookings WHERE k_status = 'Confirmed' OR k_status = 'Direct' AND TIMESTAMPDIFF(HOUR, k_date_and_time, NOW()) = 24");
