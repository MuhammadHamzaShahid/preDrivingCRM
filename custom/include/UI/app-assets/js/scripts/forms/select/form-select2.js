...
(function (window, document, $) {
  ...
  jq331(".js-programmatic-set-val").on("click", function () {
    $select.val("CA").trigger("change");
  });

  jq331(".js-programmatic-open").on("click", function () {
    $select.select2("open");
  });
  jq331(".js-programmatic-close").on("click", function () {
    $select.select2("close");
  });

  jq331(".js-programmatic-init").on("click", function () {
    $select.select2();
  });
  jq331(".js-programmatic-destroy").on("click", function () {
    $select.select2("destroy");
  });

  jq331(".js-programmatic-multi-set-val").on("click", function () {
    $selectMulti.val(["CA", "AL"]).trigger("change");
  });
  jq331(".js-programmatic-multi-clear").on("click", function () {
  ...
  function formatRepo(repo) {
    ...
    markup +=
      ...
      "<div class='select2-result-repository__forks'><i class='fa fa-code-branch mr-0'></i> " +
      repo.forks_count +
      " Forks</div>" +
      "<div class='select2-result-repository__stargazers'><i class='fa fa-star mr-0'></i> " +
      repo.stargazers_count +
      " Stars</div>" +
      "<div class='select2-result-repository__watchers'><i class='fa fa-eye mr-0'></i> " +
      repo.watchers_count +
      " Watchers</div>" +
      "</div>" +
      "</div></div>";
  ...
  jq331("select[data-text-color]").each(function (i, obj) {
    var text = jq331(this).data("text-color"),
      textVariation;
    textVariation = jq331(this).data("text-variation");
    if (textVariation !== "") {
      textVariation = " " + textVariation;
